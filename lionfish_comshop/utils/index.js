      ...
      app.util.request({
        ...
        success: function (res) {
          if (res.data.code == 0) {
            ...
            if (navBackUrl) {
              if (navBackUrl.indexOf('lionfish_comshop/pages/index/index') != -1 || navBackUrl.indexOf('lionfish_comshop/pages/order/shopCart') != -1 || navBackUrl.indexOf('lionfish_comshop/pages/user/me') != -1 || navBackUrl.indexOf('lionfish_comshop/pages/type/index') != -1) {
                wx.switchTab({ 
                  url: navBackUrl,
                  success: () => {
    ...
    app.util.request({
      ...
      success: function (res) {
        if (res.data.code == 0) {
          ...
          wx.setNavigationBarColor({ frontColor: nav_font_color, backgroundColor: nav_bg_color })
          wcache.put('navBgColor', nav_bg_color, 600);
          wcache.put('navFontColor', nav_font_color, 600);
        }
      }
    })
  } else {
    wx.setNavigationBarColor({ frontColor: navFontColor, backgroundColor: navBgColor })
  }
}
      ...
      app.util.request({
        ...
        success: function (res) {
          if (res.data.code == 0) {
            ...
            let iconArr = {home: '', car: '', user: ''};
            iconArr.home = list['i1'] || '/lionfish_comshop/images/icon-tab-index.png';
            iconArr.car = list['i2'] || '/lionfish_comshop/images/icon-tab-shop.png';
            iconArr.user = list['i3'] || '/lionfish_comshop/images/icon-tab-me.png'; 
            resolve(iconArr);
          }
        }
      })
    } else {
      let iconArr = { home: '', car: '' };
