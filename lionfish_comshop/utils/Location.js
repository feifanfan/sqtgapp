  ...
  wx.authorize({
    ...
    success: function () {
      console.log("get GPS success"), wx.getLocation({
        ...
        fail: function () {
          console.log("get GPS location fail"), app.globalData.canGetGPS = false, fn;
        }
      });
    },
    fail: function () {
      console.log("get GPS fail checkGPS"), app.globalData.canGetGPS = false, console.log(fn()), fn;
    }
  });
}
