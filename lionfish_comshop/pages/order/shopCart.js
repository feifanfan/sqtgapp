...
Page({
   ...
   */
  calcAmount: function() {
    let { is_open_vipcard_buy, is_vip_card_member, carts, delivery_tuanz_money, man_free_tuanzshipping, vipcard_save_money, canLevelBuy, level_save_money, allcount } = this.data;
    ...
    console.log('deliveryGoodsTot', deliveryGoodsTot)
    ...
    let vipTotal = allcount * 1 - vipFee;
    let levelToTal = allcount * 1 - levelFee;
    this.setData({
      totalAmount,
